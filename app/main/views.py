...
def add_article():
    ...
    title = 'Add a article'
    return render_template('add_article.html',title = title,articleform = form)
...
def comment(article_id):
    ...
    return render_template('article_discussion.html',title = title,article = article,comments=comments)
...
def update(article_id):
    ...
    return render_template('add_article.html',title = 'update article',articleform = form)
